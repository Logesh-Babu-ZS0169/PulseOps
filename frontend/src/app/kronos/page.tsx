...
export default function Dashboard() {
  ...
  const fetchData = async (date?: Dayjs, start?: Dayjs | null, end?: Dayjs | null) => {
    ...
    try {
      ...
      const [dailyRes, commercialRes, gbdRes] = await Promise.all([
        axios.get(`${config.API_URL}/api/metrics/daily-total`, { params, headers }),
        axios.get(`${config.API_URL}/api/metrics/hourly/commercial`, { params, headers }),
        axios.get(`${config.API_URL}/api/metrics/hourly/gbd`, { params, headers }),
      ]);
  ...
  const fetchFailureRecoveryData = async (date?: Dayjs, start?: Dayjs | null, end?: Dayjs | null) => {
    try {
      ...
      const [recovered, waiting, inboundFailed, processFailed, aborted] = await Promise.all([
        axios.get(`${config.API_URL}/api/failure-recovery/recovered`, { params, headers }),
        axios.get(`${config.API_URL}/api/failure-recovery/waiting`, { params, headers }),
        axios.get(`${config.API_URL}/api/failure-recovery/inbound-failed`, { params, headers }),
        axios.get(`${config.API_URL}/api/failure-recovery/process-failed`, { params, headers }),
        axios.get(`${config.API_URL}/api/failure-recovery/aborted`, { params,headers }),
      ]);
  ...
  const fetchPredictionData = async () => {
    try {
      ...
      const response = await axios.get(`${config.API_URL}/api/prediction/next-day`, {headers});
  ...
  const fetchHourlyPredictionData = async () => {
    try {
      ...
      const response = await axios.get(`${config.API_URL}/api/prediction/hourly`, { headers });
  ...
  const fetchDayWisePredictionData = async () => {
    try {
      ...
      const response = await axios.get(`${config.API_URL}/api/prediction/day-wise`, { params: { days: 7 }, headers });
